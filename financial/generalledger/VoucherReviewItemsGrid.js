/* Filename: financial/generalledger/VoucherReviewItemsGrid.js */
...
const VoucherReviewItemsGrid = ({ 
  ...
  const handleFetchAutoRate = async (type) => {
    ...
    try {
        ...
        alert(isRtl ? 'خطای اتصال به دیتابیس در خواندن نرخ ارز.' : 'Error fetching rate.');
    } finally {
        setFetchingRate(false);
    }
  };
...
window.VoucherReviewItemsGrid = VoucherReviewItemsGrid;
export default VoucherReviewItemsGrid;