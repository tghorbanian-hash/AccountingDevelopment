...
export const GL_TRANS = {
  en: {
    ...
    coa_subtitle: "Manage Group, General, and Subsidiary accounts tree",
    coa_tree: "Accounts Tree",
    coa_settings: "Coding Structure",
    coa_group_len: "Group Length",
    coa_gen_len: "General Length",
    coa_sub_len: "Subsidiary Length",
    coa_use_char: "Use Characters",
    coa_level_group: "Group",
    coa_level_gen: "General",
    coa_level_sub: "Subsidiary",
    coa_tab_info: "General Info",
    coa_tab_tafsil: "Detail Accounts",
    coa_tab_desc: "Standard Descriptions",
    coa_feat_curr: "Currency Feature",
    coa_feat_track: "Tracking Feature",
    coa_feat_qty: "Quantity Feature",
    coa_nat_ctrl: "Nature Control",
    coa_new_group: "New Group",
    coa_new_gen: "New General",
    coa_new_sub: "New Subsidiary",
    coa_msg_locked: "Structure is locked after creating the first account.",
  ...
  fa: {
    ...
    coa_subtitle: "مدیریت درخت حساب‌های گروه، کل و معین",
    coa_tree: "درخت حساب‌ها",
    coa_settings: "تنظیمات ساختار",
    coa_group_len: "طول کد گروه",
    coa_gen_len: "طول کد کل",
    coa_sub_len: "طول کد معین",
    coa_use_char: "استفاده از کاراکتر",
    coa_level_group: "گروه",
    coa_level_gen: "کل",
    coa_level_sub: "معین",
    coa_tab_info: "اطلاعات اصلی",
    coa_tab_tafsil: "تفصیل‌ها",
    coa_tab_desc: "شرح‌های استاندارد",
    coa_feat_curr: "ویژگی ارزی",
    coa_feat_track: "ویژگی پیگیری",
    coa_feat_qty: "ویژگی مقداری",
    coa_nat_ctrl: "کنترل ماهیت",
    coa_new_group: "گروه حساب جدید",
    coa_new_gen: "حساب کل جدید",
    coa_new_sub: "حساب معین جدید",
    coa_msg_locked: "پس از تعریف اولین حساب، تغییر طول کدها امکان‌پذیر نیست.",
